...
:dados
cls
echo Iniciando a execucao do Teste Automatico AMBIENTE WHPMEX
echo:
echo:
...
set "ORIGEM=8|Padr"
set "DESTINO=9919|Padr"
set "FOLDER=RDF"
set "PROJETO=Teste Automatizado RDF"
set "USER_NEOLOG=neolog@neolog.com.br"
set "USER_MDC="
set "USER_SELECAO="
set "USER_SELECAO_RETORNO="
set "CONTEXTO=Default"
set "VEICULO=3/4 (4,5t)"
set "TRANSPORTADORA=TRANSPORTADORA NACIONAL LTDA"
