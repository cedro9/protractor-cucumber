...
Dado que cadastro a restrição de localidade "RESTLOCDEPOPM"
...
Dado que cadastro a origem "LOCORIGEMDEPOPM" com a restrição de localidade "RESTLOCDEPOPM" e Cep "08061-020"
...
Dado que cadastro o destino "LOCDESTDEPOPM" com a restrição de localidade "RESTLOCDEPOPM" e Cep "08061-020"
Dado que cadastro o destino "LOCDESTDEPOPM2" com a restrição de localidade "RESTLOCDEPOPM" e Cep "08061-020"
Dado que cadastro o hub de destino "LOCDESTHUBDEPOPM" com a restrição de localidade "RESTLOCDEPOPM" e Cep "08061-020"
...
Dado que cadastro o pedido "PEDIDOOPM01" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
Dado que cadastro o pedido "PEDIDOOPM02" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
...
Dado que cadastro o pedido "PEDIDOOPM04" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
...
Dado que cadastro o pedido "PEDIDOOPM13" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
Dado que cadastro o pedido "PEDIDOOPM14" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
...
Dado que cadastro o pedido "PEDIDOOPM16" do embarcador "EMBDEPOPM1" tipo de pedido "TIPOPEDIDODEPOPM" destino "LOCDESTDEPOPM" origem "LOCORIGEMDEPOPM" produto "PRODDEPOPM1" item de pedido "TIPOITEMDEPOPM" e invólucro "INVDEPOPM1" e Hub de destino "LOCDESTHUBDEPOPM"
Dado que cadastro a viagem para o pedido "PEDIDOOPM03" com a transportadora "TRANSDEPOPM1" e veículo "VEICULODEPOPM1"
Dado que cadastro a viagem para o pedido "PEDIDOOPM04" com a transportadora "TRANSDEPOPM1" e veículo "VEICULODEPOPM1"
...
Dado que cadastro a viagem para o pedido "PEDIDOOPM13" com a transportadora "TRANSDEPOPM1" e veículo "VEICULODEPOPM1"
Dado que cadastro a viagem para o pedido "PEDIDOOPM14" com a transportadora "TRANSDEPOPM1" e veículo "VEICULODEPOPM1"
...
Quando filtro a cesta geral pelo pedido "PEDIDOOPM16"
Quando seleciono o pedido "PEDIDOOPM16" na cesta geral
Quando clico em Mover seleção aqui na cesta do usuário
Dado que desabilito a exibiçao da Cesta Geral e Viagens
Quando filtro a cesta do usuário pelo pedido "PEDIDOOPM16"
Quando seleciono o pedido "PEDIDOOPM16" na cesta do usuário
...
Quando na cesta do usuario clico para exibir os detalhes da UT "PEDIDOOPM16/1"
Entao valido se o destino é o "LOCDESTHUBDEPOPM"
Quando filtro a cesta do usuário pelo pedido "PEDIDOOPM16"
Quando seleciono o pedido "PEDIDOOPM16" na cesta do usuário
Quando Clico no botão Unidade de Transporte e Alterar Destinos
...
Dado que acesso a tela "Programação", "Análise"
Quando filtro a cesta geral pelo pedido "PEDIDOOPM01"
Quando seleciono o pedido "PEDIDOOPM01" na cesta geral
Quando clico em Mover seleção aqui na cesta do usuário
Dado que desabilito a exibiçao da Cesta Geral e Viagens
Quando filtro a cesta do usuário pelo pedido "PEDIDOOPM01"
Quando seleciono o pedido "PEDIDOOPM01" na cesta do usuário
Quando Clico no botão Unidade de Transporte e Alterar Destinos
...
E clico no botão OK
Quando na cesta do usuario clico para expandir o pedido
Quando na cesta do usuario clico para exibir os detalhes da UT "PEDIDOOPM01/1"
Entao valido se o destino é o "LOCDESTHUBDEPOPM"
Quando seleciono o pedido "PEDIDOOPM01" na cesta do usuário
E clico no botão Mover para cesta Geral
...
Dado que acesso a tela "Programação", "Análise"
Quando filtro a cesta geral pelo pedido "PEDIDOOPM02"
Quando seleciono o pedido "PEDIDOOPM02" na cesta geral
Quando clico em Mover seleção aqui na cesta do usuário
Dado que desabilito a exibiçao da Cesta Geral e Viagens
Quando filtro a cesta do usuário pelo pedido "PEDIDOOPM02"
Quando seleciono o pedido "PEDIDOOPM02" na cesta do usuário
Quando Clico no botão Unidade de Transporte e Alterar Destinos
...
E clico no botão OK
Quando na cesta do usuario clico para expandir o pedido
Quando na cesta do usuario clico para exibir os detalhes da UT "PEDIDOOPM02/1"
Entao valido se o destino é o "LOCDESTHUBDEPOPM"
Quando seleciono o pedido "PEDIDOOPM02" na cesta do usuário
E clico no botão Mover para cesta Geral
...
# Quando clico em edição de viagem
# Quando altero o veiculo para "VEICULODEPOPM1"
# E clico no botão salvar e uso o contexto de otimização padrão
# E na mensagem "Violações" clico no botão "Salvar"
# Entao é exibido a mensagem "Edição feita com sucesso"
# E clico no botão OK
...
Quando clico no botão Cesta geral
Quando clico no botão Minha cesta
Quando filtro a cesta de viagem pelo pedido "PEDIDOOPM04"
Quando clico em edição de viagem
Quando altero a transportadora para "TRANSDEPOPM2"
E clico no botão salvar e uso o contexto de otimização padrão
E na mensagem "Violações" clico no botão "Salvar"
Entao é exibido a mensagem "Edição feita com sucesso"
E clico no botão OK
Entao a transportadora "TRANSDEPOPM2" é exibido para a viagem alterada
# Quando clico em edição de viagem
# Quando altero a transportadora para "TRANSDEPOPM1"
# E clico no botão salvar e uso o contexto de otimização padrão
# E na mensagem "Violações" clico no botão "Salvar"
# Entao é exibido a mensagem "Edição feita com sucesso"
# E clico no botão OK
...
Quando verifico o tipo de serviço da carga "2"
...
Quando clico no botão Cesta geral
Quando clico no botão Minha cesta
Quando filtro a cesta de viagem pelo pedido "PEDIDOOPM13"
Quando clico em edição de viagem
...
Dado que excluo a viagem "PEDIDOOPM03"
Dado que excluo a viagem "PEDIDOOPM04"
Dado que excluo a viagem "PEDIDOOPM05"
Dado que excluo a viagem "PEDIDOOPM06"
Dado que excluo a viagem "PEDIDOOPM07"
Dado que excluo a viagem "PEDIDOOPM08"
Dado que excluo a viagem "PEDIDOOPM09"
Dado que excluo a viagem "PEDIDOOPM10"
Dado que excluo a viagem "PEDIDOOPM11"
Dado que excluo a viagem "PEDIDOOPM12"
Dado que excluo a viagem "PEDIDOOPM13"
Dado que excluo a viagem "PEDIDOOPM14"
Dado que excluo o pedido "PEDIDOOPM01"
Dado que excluo o pedido "PEDIDOOPM02"
Dado que excluo o pedido "PEDIDOOPM03"
Dado que excluo o pedido "PEDIDOOPM04"
...
Dado que excluo o pedido "PEDIDOOPM13"
Dado que excluo o pedido "PEDIDOOPM14"
Dado que excluo o pedido "PEDIDOOPM15"
Dado que excluo o pedido "PEDIDOOPM16"
# Dado que removo a transportadora "TRANSDEPOPM2" e a origem "LOCORIGEMDEPOPM" do parâmetro "Transportadoras permitidas por origem e localidade/zt"
...
Dado que excluo a restrição de localidade "RESTLOCDEPOPM"