...
set "FOLDER=WHPMEX"
set "VEICULO_OPM=Camioneta"
set "CLIENT_NAME=whp-mex"
set "TIPO_SERVICO_OPM=FTL Continuous moves"
set "EMBARCADOR="
set "TIPO_PEDIDO=BB"
set "ORIGEM=RM06"
set "DESTINO=2085346"
set "PRODUTO="
set "ITEM_PEDIDO=Padrao"
set "TRANS_OPM=AUTOTRANSPORTES GARCOR, SA DE CV"

cmd /c npm run whp-mex
echo:
echo:
