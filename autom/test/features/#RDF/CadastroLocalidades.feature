...
Dado que cadastro a zona de transporte "ZTDEPLOC" para o agrupador "AZTDEPLOC" com a restrição de localidade "RESLOCDEPLOC" e prioridade "0"
...
Cenario: Cadastrar localidade de destino com sucesso - Geocodificação reversa pelas coordenadas
Dado que acesso a tela "Cadastro", "Localidades"
E clico no botão Cadastro
