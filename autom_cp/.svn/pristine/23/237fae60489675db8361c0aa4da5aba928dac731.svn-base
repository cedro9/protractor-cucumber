...
Dado que cadastro a restrição de localidade "RESLOCDEPFBVM"
Dado que cadastro o calculador de frete viagem "CALCFRETEVIAGEMDEPFBVM"
Dado que cadastro a origem "ORIDEPFBVM" com a restrição de localidade "RESLOCDEPFBVM" e Cep "06273-070"
Dado que cadastro o destino "DESTDEPFBVM" com a restrição de localidade "RESLOCDEPFBVM" e Cep "90520-310"
Dado que cadastro o hub de destino "HUBDESDEPFBVM" com a restrição de localidade "RESLOCDEPFBVM" e Cep "76820-408"
...
Dado que cadastro a zona de transporte "ZTDEPFBVM" para o agrupador "AZTDEPFBVM" com a restrição de localidade "RESLOCDEPFBVM" e prioridade "15"
...
Dado que cadastro o pedido "PEDIDOFBVM12" do embarcador "EMBDEPFBVM" tipo de pedido "TIPOPEDDEPFBVM" destino "DESTDEPFBVM" origem "ORIDEPFBVM" produto "PRODDEPFBVM" item de pedido "TIPITEDEPFBVM" e invólucro "INVDEPFBVM" e Hub de destino "HUBDESDEPFBVM"
...
Dado que cadastro o pedido "PEDIDOFBVM17" do embarcador "EMBDEPFBVM" tipo de pedido "TIPOPEDDEPFBVM" destino "DESTDEPFBVM" origem "ORIDEPFBVM" produto "PRODDEPFBVM" item de pedido "TIPITEDEPFBVM" e invólucro "INVDEPFBVM" e Hub de destino "HUBDESDEPFBVM"
...
Dado que cadastro o pedido "PEDIDOFBVM22" do embarcador "EMBDEPFBVM" tipo de pedido "TIPOPEDDEPFBVM" destino "DESTDEPFBVM" origem "ORIDEPFBVM" produto "PRODDEPFBVM" item de pedido "TIPITEDEPFBVM" e invólucro "INVDEPFBVM" e Hub de destino "HUBDESDEPFBVM"
Dado que cadastro o pedido "PEDIDOFBVM23" do embarcador "EMBDEPFBVM" tipo de pedido "TIPOPEDDEPFBVM" destino "DESTDEPFBVM" origem "ORIDEPFBVM" produto "PRODDEPFBVM" item de pedido "TIPITEDEPFBVM" e invólucro "INVDEPFBVM" e Hub de destino "HUBDESDEPFBVM"
...
Dado que copio o pedido "0279961571" e defino seu código como "PEDIDOFBVM26"
...
Dado que edito o parâmetro genérico Regras para classificação com agrupador "Estado" zona de transporte "SÃO PAULO" e Taxa default "1"
Dado que copio o contexto "SCR_Otimização Sem Frete" e defino seu código como "CONTEXTODEP01"
Dado que removo o pré-validadores de otimização hard "Localidades sem configuração de Zona de Transporte" do contexto de otimização "CONTEXTODEP01"
...
Dado que acesso a tela "Programação", "Análise"
Quando filtro a cesta geral pelo pedido "PEDIDOFBVM12"
Quando seleciono o pedido "PEDIDOFBVM12" na cesta geral
E clico no botão "Mover pedidos para minha cesta"
Quando filtro a cesta do usuário pelo pedido "PEDIDOFBVM12"
Quando seleciono o pedido "PEDIDOFBVM12" na cesta do usuário
E clico em Mover seleção aqui na cesta de viagem
E preencho a quantidade de UE "8"
E clico no botão OK
E clico no botão "Salvar"
Quando filtro a cesta de viagem pelo pedido "PEDIDOFBVM12"
Quando clico em Expandir todos os níveis da viagem
Entao verifico se o pedido "PEDIDOFBVM12" está presente na viagem
Quando clico no botão detalhe do pedido "PEDIDOFBVM12"
...
Dado que acesso a tela "Programação", "Análise"
Quando filtro a cesta geral pelo pedido "PEDIDOFBVM17"
Quando seleciono o pedido "PEDIDOFBVM17" na cesta geral
E clico no botão "Mover pedidos para minha cesta"
E clico no botão Cesta geral
Quando filtro a cesta do usuário pelo pedido "PEDIDOFBVM17"
Quando seleciono o pedido "PEDIDOFBVM17" na cesta do usuário
E clico em Mover seleção aqui na cesta de viagem
E clico no botão OK
E clico no botão "Salvar"
Quando filtro a cesta de viagem pelo pedido "PEDIDOFBVM17"
Quando clico em Expandir todos os níveis da viagem
Entao verifico se o pedido "PEDIDOFBVM17" está presente na viagem
Quando seleciono o pedido "PEDIDOFBVM17" na carga
E clico em Mover seleção aqui na cesta do usuário
E preencho a quantidade de UE "5"
E clico no botão OK
E clico no botão "Salvar"
Quando clico em Expandir todos os níveis da viagem
Quando clico no botão detalhe do pedido "PEDIDOFBVM17"
...
Dado que acesso a tela "Programação", "Análise"
Quando filtro a cesta geral pelo pedido "PEDIDOFBVM22,PEDIDOFBVM23"
E clico no botão "Mover todas as páginas para a cesta"
E clico no botão Cesta geral
Quando filtro a cesta do usuário pelo pedido "PEDIDOFBVM22,PEDIDOFBVM23"
Quando clico para ser exibido 50 registros
Quando seleciono o pedido "PEDIDOFBVM22" na cesta do usuário
E clico em Mover seleção aqui na cesta de viagem
E clico no botão OK
E clico no botão "Salvar"
Quando seleciono o pedido "PEDIDOFBVM23" na cesta do usuário
E clico no botão Minha cesta
E clico em Mover seleção aqui na cesta de viagem
E clico no botão OK
E clico no botão "Salvar"
Quando filtro a cesta de viagem pelo pedido "PEDIDOFBVM22,PEDIDOFBVM23"
Quando clico em Expandir todos os níveis da viagem
Quando seleciono o pedido "PEDIDOFBVM23" na carga
...
E clico no botão "Salvar"
Quando clico em Expandir todos os níveis da viagem
Entao verifico se o pedido "PEDIDOFBVM23" está presente na viagem
E clico em Selecionar viagens
Entao cancelo a viagem
E clico no botão Minha cesta
Quando filtro a cesta do usuário pelo pedido "PEDIDOFBVM22,PEDIDOFBVM23"
...
E clico no botão otimizar todas as páginas selecionando o contexto de otimização "CONTEXTODEP01"
...
Dado que excluo o pedido "PEDIDOFBVM12"
...
Dado que excluo o pedido "PEDIDOFBVM17"
...
Dado que excluo o pedido "PEDIDOFBVM22"
Dado que excluo o pedido "PEDIDOFBVM23"
Dado que excluo o pedido "PEDIDOFBVM24"
Dado que excluo o pedido "PEDIDOFBVM25"
Dado que excluo o pedido "PEDIDOFBVM26"
...
Dado que edito o parâmetro genérico Regras para classificação com agrupador "Estado" zona de transporte "SÃO PAULO" e Taxa default "60"
Dado que removo o contexto de otimização "CONTEXTODEP01"