...
@FluxosPartnerCollaborantionGRD
...
Dado que altero para dias a unidade de tempo de execução da task "TripOfferPoolFinalizerTask"
...
E seleciono a viagem
E aceito a viagem ofertada no pool
...
Cenario: Atribuir transportadora à viagem rejeitada pool
Dado que acesso a tela "Programação", "Análise"
E clico no botão Cesta geral
E clico no botão Minha cesta
E filtro a cesta de viagem pelo pedido "PEDIDOPC25"
E seleciono a viagem
E oferto a viagem
Dado que acesso a tela "Programação", "Partner collaboration"
E filtro a cesta de viagem pelo pedido "PEDIDOPC25"
...
Então verifico a transportadora da viagem "TRANDEPPC02"
E seleciono a viagem
E cancelo a oferta da viagem
